...
import com.example.usermanage.dtos.ReqRes;

import com.example.usermanage.entities.OurUsers;
import com.example.usermanage.services.UsersManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<?> addRoom(@RequestParam("file") MultipartFile file, @RequestParam("data") String data) {
        try {
            ...
            OurUsers ourUsers = objectMapper.readValue(data, OurUsers.class);
            usersManagementService.addFile(ourUsers, file);
